...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ZXCVBNMASDFGHJKLQWERTYUIOP0786/ShivMusicBot",
)
...
PLAYLIST_IMG_URL = "https://files.catbox.moe/zgy7zs.jpg"
...
DURATION_LIMIT = int(time_to_seconds(f"{DURATION_LIMIT_MIN}:360000"))
